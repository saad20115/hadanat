...
return [
    ...
    'fields' => [
        ...
        'language_helper' => "L'interface d'administration sera affichée dans cette langue.",
    ],
    ...
    'password' => [
        ...
        'helper'      => 'Doit comporter au moins 8 caractères.',
        ...
        'current-helper' => 'Saisissez votre mot de passe actuel pour vérifier votre identité.',
